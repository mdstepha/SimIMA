function map = getConnectedBlockTypesWithCountByBlockPath(blockPath, connectionType)
...
% connectionType(str/char) : src/dst/both 
    ...
    handles = getConnectedBlockHandlesByBlockPath(blockPath, connectionType);  % may raise error 
